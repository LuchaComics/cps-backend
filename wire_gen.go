...
func InitializeEvent() Application {
	...
	submissionController := controller4.NewController(conf, slogLogger, provider, s3Storager, passwordProvider, kmutexProvider, cpsrnProvider, cbffBuilder, emailer, userStorer, submissionStorer, organizationStorer)
