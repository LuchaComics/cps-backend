...
func (c *SubmissionControllerImpl) Create(ctx context.Context, m *s_d.Submission) (*s_d.Submission, error) {
	...
	r := &pdfbuilder.CBFFBuilderRequestDTO{
		...
		SpecialNotesLine6:                  m.SpecialNotesLine6,
		SpecialNotesLine7:                  m.SpecialNotesLine7,
		SpecialNotesLine8:                  m.SpecialNotesLine8,
		SpecialNotesLine9:                  m.SpecialNotesLine9,
		SpecialNotesLine10:                 m.SpecialNotesLine10,
		SpecialNotesLine11:                 m.SpecialNotesLine11,
		SpecialNotesLine12:                 m.SpecialNotesLine12,
		SpecialNotesLine13:                 m.SpecialNotesLine13,
		...
		GradingNotesLine6:                  m.GradingNotesLine6,
		GradingNotesLine7:                  m.GradingNotesLine7,
		GradingNotesLine8:                  m.GradingNotesLine8,
		GradingNotesLine9:                  m.GradingNotesLine9,
		GradingNotesLine10:                 m.GradingNotesLine10,
		GradingNotesLine11:                 m.GradingNotesLine11,
		GradingNotesLine12:                 m.GradingNotesLine12,
		GradingNotesLine13:                 m.GradingNotesLine13,
